...
export default function AgentDashboardContainer() {
    // Dummy data
    const kpiData = [
        { title: "Total Merchants", value: "45", icon: Users, trend: "up", trendValue: "+12%" },
        { title: "Total Earnings", value: "$12,450", icon: DollarSign, trend: "up", trendValue: "+8.2%" },
        { title: "Active Merchants", value: "38", icon: UserCheck, trend: "up", trendValue: "+5%" },
    ];

    const recentActivities = [
        { id: 1, merchant: "Coffee House", action: "New subscription", time: "2 hours ago" },
        { id: 2, merchant: "Pizza Palace", action: "Coupon batch created", time: "5 hours ago" },
        { id: 3, merchant: "Beauty Salon", action: "Credits purchased", time: "1 day ago" },
        { id: 4, merchant: "Pet Store", action: "WhatsApp campaign activated", time: "2 days ago" },
        { id: 5, merchant: "Book Shop", action: "Annual subscription renewed", time: "3 days ago" },
    ];
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between border-b pb-3">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Generated on May 28, 2024</p>
                                </div>
                                <Button variant="outline" size="sm">Download</Button>
                            </div>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Generated on May 25, 2024</p>
                                </div>
                                <Button variant="outline" size="sm">Download</Button>
                            </div>
                        </div>
