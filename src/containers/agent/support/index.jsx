...
export default function AgentSupportContainer() {
    ...
    // Dummy ticket data
    const tickets = [
        { id: 1, merchant: "Coffee House", subject: "Issue with coupon redemption", status: "open", date: "2024-06-02", lastMessage: "The QR code scanner is not responding..." },
        { id: 2, merchant: "Pizza Palace", subject: "Question about billing", status: "resolved", date: "2024-05-30", lastMessage: "Thank you for clarifying the charges." },
        { id: 3, merchant: "Beauty Salon", subject: "Feature request", status: "open", date: "2024-06-01", lastMessage: "Can we add birthday automations?" },
                        ...
                        {tickets.map((ticket) => (
                            ...
                            >
                                <div className="flex justify-between items-start mb-1">
                                    <span className="font-semibold truncate">{ticket.merchant}</span>
                                    <span className="text-xs text-muted-foreground whitespace-nowrap">{ticket.date}</span>
                                </div>
                                ...
                                <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-muted/10">
                                    ...
                                    <div className="flex justify-end">
                                        <div className="bg-primary text-primary-foreground rounded-lg p-3 max-w-[80%] shadow-sm">
                                            <p className="text-sm">Hello, thanks for reaching out. We are looking into this for you.</p>
                                            <span className="text-xs text-primary-foreground/70 mt-1 block">10:35 AM</span>
                                        </div>
                                    </div>
                                </div>
