...
export default function MerchantLuckyDrawContainer() {
    // Dummy winners
    const winners = [
        { id: 1, name: "John Doe", prize: "Free Dinner", date: "2024-06-01", status: "claimed" },
        { id: 2, name: "Jane Smith", prize: "$50 Voucher", date: "2024-05-15", status: "claimed" },
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-white p-3 rounded-lg border text-center">
                                <p className="text-xs text-muted-foreground uppercase tracking-wide">Last Draw</p>
                                <p className="font-semibold">June 1, 2024</p>
                            </div>
                            <div className="bg-white p-3 rounded-lg border text-center">
                                <p className="text-xs text-muted-foreground uppercase tracking-wide">Total Winners</p>
